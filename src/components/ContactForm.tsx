...
const ContactForm = ({ children }: PropsWithChildren) => {
    ...
    return (
        <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="bg-[#0a0a14] flex flex-col p-8 rounded-2xl border border-[#e6c478]/20">
                ...
                <button type="submit" className="bg-[#e6c478] hover:bg-[#d4b366] text-lg text-[#0a0a14] px-6 py-2 rounded-md flex flex-row items-center justify-center cursor-pointer">
                    {children}
